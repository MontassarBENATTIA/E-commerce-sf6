...
class __TwigTemplate_010773b70af6211b763e21a7dcb02e0c extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("template.html.twig", "payment/success.html.twig", 1);
    ...
    <div class=\"container-fluid bg-secondary mb-5\">
        <div class=\"d-flex flex-column align-items-center justify-content-center\" style=\"min-height: 300px\">
            <h1 class=\"font-weight-semi-bold text-uppercase mb-3\">Success</h1>
            <div class=\"d-inline-flex\">
                <p class=\"m-0\"><a href=\"\">Thanks for your order!</a></p>
            </div>
        </div>
    </div>
    ...
    <!-- Page Header End -->
            ...
            <p>
                ...
                <a href=\"mailto:orders@example.com\">order@Shop.com</a>.
            </p>
        <div>
    </div>
        </div></div>
...
{% block PageTitle %}Payment Success!{% endblock %}
...
{% endblock %}
", "payment/success.html.twig", "C:\\workspace\\E-commerce-project-main\\templates\\payment\\success.html.twig");
    }
}
