...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'CategoryFixture.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'MyEditorsFixture.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'MyJob.php';
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'MyUserFixture.php';
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'DataFixtures'.\DIRECTORY_SEPARATOR.'ProductFixture.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\CategoryFixture(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\MyEditorsFixture($b), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\MyJob(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\MyUserFixture($b), 'groups' => []], 4 => ['fixture' => new \App\DataFixtures\ProductFixture(), 'groups' => []]]);
