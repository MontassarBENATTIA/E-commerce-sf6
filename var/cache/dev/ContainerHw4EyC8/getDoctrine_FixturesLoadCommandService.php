...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\CategoryFixture(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\MyEditorsFixture($b), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\MyJob(), 'groups' => []], 3 => ['fixture' => new \App\DataFixtures\MyUserFixture($b), 'groups' => []]]);
