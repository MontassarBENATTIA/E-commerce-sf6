 ...
 */
class getLigneDeCommandeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\LigneDeCommandeRepository' shared autowired service.
     *
     * @return \App\Repository\LigneDeCommandeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LigneDeCommandeRepository.php';

        return $container->privates['App\\Repository\\LigneDeCommandeRepository'] = new \App\Repository\LigneDeCommandeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
