 ...
 */
class getCoordinateRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CoordinateRepository' shared autowired service.
     *
     * @return \App\Repository\CoordinateRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CoordinateRepository.php';

        return $container->privates['App\\Repository\\CoordinateRepository'] = new \App\Repository\CoordinateRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
