...
class getSecurityControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.qgC7ipw'] ?? $container->load('get_ServiceLocator_QgC7ipwService'))->withContext('App\\Controller\\SecurityController', $container));
